...
async function run() {
    ...
    try {
        ...
        // Capture the feed specifically to check single-column layout & hero items
        ...
        // Tìm button đàm phán trong feed (thường là button thứ 2 trong nhóm action bar của SocialPostCard)
        ...
        if (foundNegotiate) {
            ...
            // Đóng modal bằng icon X hoặc click outside
